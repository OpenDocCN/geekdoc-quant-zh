...
> 原文：[Quantinsti Blog](https://blog.quantinsti.com/)
> 
...
* [在线阅读](https://quantinsti.flygon.net)
## 下载

### Docker

```
docker pull apachecn0/quantinsti-blog-zh
docker run -tid -p <port>:80 apachecn0/quantinsti-blog-zh
...
```
npm install -g quantinsti-blog-zh
quantinsti-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
